...
COPY ar_internal_metadata (key, value, createdAt, updatedAt) FROM stdin;
...
COPY employees (id, firstName, lastName, age, createdAt, updatedAt) FROM stdin;
...
COPY positions (id, employeeId, departmentId, title, historicalIndex, createdAt, updatedAt) FROM stdin;
...
COPY posts (id, title, createdAt, updatedAt) FROM stdin;
\.
...
--
-- Name: index_positions_on_departmentId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_positions_on_departmentId ON positions USING btree (departmentId);


--
-- Name: index_positions_on_employeeId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_positions_on_employeeId ON positions USING btree (employeeId);
